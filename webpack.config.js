...
module.exports = {
	...
	plugins: [
		...buildHTML(['index', 'checkout', 'elite', 'gummies', 'home', 'carry-case', 'recovery-extension', 'recovery-message', 'faq', 'who_we_are', 'buying_guide', 'refunds_and_returns', 'privacy', 'what_we_do', 'how_to_use']),
